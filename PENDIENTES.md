...
- [x] **Registros/permisos sanitarios**: gerencia indicó omitir el tema por ahora (ago 2026). Se hizo un pase de redacción: el sitio ya no afirma verificación INVIMA propia — habla de "cumplimiento normativo" y "registro sanitario vigente" (de los productos); INVIMA solo aparece como requisito a proveedores y como tema de asesoría. *Cuando lleguen los permisos, se pueden publicar los números y restaurar el lenguaje específico.*
- [x] **Director Técnico / Químico Farmacéutico**: gerencia indicó omitir la figura del DT por ahora, conservando la asesoría (ago 2026). El sitio ofrece "consulta especializada con químico farmacéutico" sin afirmar cargo ni contratación. *Cuando el DT esté formalizado, se puede retomar el título y (si autoriza) su nombre.*
...
- [ ] **Términos y condiciones / aviso legal**: borrador v0 redactado y publicado en `/terminos-y-condiciones` (ago 2026), enlazado en el footer. **Pendiente: revisión y aprobación de gerencia o asesor legal** — en especial la sección 6 (devoluciones y garantías), que hoy remite a condiciones comerciales pactadas.
