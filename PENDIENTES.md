...
- [ ] **Razón social exacta y NIT** para el footer (¿"TMI COL S.A.S." es la razón social registrada tal cual?).
...
- [ ] **Logo oficial**: ¿existe logo real de TMI (vectorial, .svg/.ai)? El sitio usa un logo tipográfico provisional "TM".
